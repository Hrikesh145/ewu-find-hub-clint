    ...
    <header className={`nb ${scrolled ? 'nb--scrolled' : ''}`}>
        ...
        <div className="nb__right">
          ...
          {user ? (
            <div className="nb__avatar-wrap" ref={dropRef}>
              ...
              >
                {user.photoURL
                  ? <img src={user.photoURL} alt={user.displayName} className="nb__avatar-img" referrerPolicy="no-referrer"/>
              ...
              {dropOpen && (
                <div className="nb__drop">
                  ...
                  {DROPDOWN_LINKS.map(({ to, label }) => (
                    <Link key={to} to={to} className="nb__drop-item" onClick={closeAll}>
                      {label}
                    </Link>
                  ))}
      ...
      {menuOpen && (
        <div className="nb__mobile">
          {NAV_LINKS.map(({ to, label, end }) => (
            <NavLink
              key={to} to={to} end={end} onClick={closeAll}
              className={({ isActive }) =>
          ...
          {user ? (
            ...
            <div className="nb__mobile-auth">
              <Link to="/login" className="nb__btn-blue nb__btn-blue--full" onClick={closeAll}>
                Login
              </Link>
            </div>
          )}
